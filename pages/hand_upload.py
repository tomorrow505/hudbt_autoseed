...
class HandUploadPage(tk.Frame):
    ...
    def get_descr(self):
        ...
        if not self.origin_torrent_path:
            ...
            if self.var_video_dir:
                ...
                torrent_info = common_methods.parser_torrent(self.raw_info['torrent_path'])
    ...
    def submit_task(self):
        ...
        tt = autoseed_task.AutoSeed(self.qb, self.raw_info, self.config_dl)
        tt.fak_upload()
        self.cancel_task()
