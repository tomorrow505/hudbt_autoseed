...
class RssPage(tk.Frame):  # 继承Frame类
    ...
    def __init__(self, parent, controller):
        ...
        self.entry_rss_link = tk.Entry(self, textvariable=self.var_rss_link, width=58, borderwidth=2,
                                       font=('Helvetica', '12'))
        self.entry_rss_name = tk.Entry(self, textvariable=self.var_rss_name, width=58, borderwidth=2,
                                       font=('Helvetica', '12'))
        self.entry_rss_site = tk.Entry(self, textvariable=self.var_rss_site, width=58, borderwidth=2,
                                       font=('Helvetica', '12'))
