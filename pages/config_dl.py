...
class ConfigDlPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.label_up_to = tk.Label(self.frame, text='发布到：', anchor=tk.W)

        self.bool_check_hudbt = tk.IntVar()
        self.bool_check_nypt = tk.IntVar()
        self.bool_check_tjupt = tk.IntVar()
        self.bool_check_mteam = tk.IntVar()

        self.check_hudbt = tk.Checkbutton(self.frame, text='蝴蝶', variable=self.bool_check_hudbt, anchor=tk.W)
        self.check_nypt = tk.Checkbutton(self.frame, text='南洋', variable=self.bool_check_nypt, anchor=tk.W)
        self.check_tjupt = tk.Checkbutton(self.frame, text='北洋', variable=self.bool_check_tjupt, anchor=tk.W)
        self.check_mteam = tk.Checkbutton(self.frame, text='馒头', variable=self.bool_check_mteam, anchor=tk.W)

        self.bool_check_ssd = tk.IntVar()
        self.bool_check_ourbits = tk.IntVar()
        self.bool_check_hdsky = tk.IntVar()
        self.bool_check_hdchina = tk.IntVar()
        self.bool_check_ttg = tk.IntVar()
        self.bool_check_pter = tk.IntVar()

        self.check_ssd = tk.Checkbutton(self.frame, text='SSD', variable=self.bool_check_ssd, anchor=tk.W)
        self.check_ourbits = tk.Checkbutton(self.frame, text='OurBits', variable=self.bool_check_ourbits, anchor=tk.W)
        self.check_hdsky = tk.Checkbutton(self.frame, text='HDSky', variable=self.bool_check_hdsky, anchor=tk.W)
        self.check_hdchina = tk.Checkbutton(self.frame, text='HDChina', variable=self.bool_check_hdchina, anchor=tk.W)
        self.check_ttg = tk.Checkbutton(self.frame, text='TTG', variable=self.bool_check_ttg, anchor=tk.W)
        self.check_pter = tk.Checkbutton(self.frame, text='Pter', variable=self.bool_check_pter, anchor=tk.W)
    ...
    def create_page(self):
        ...
        self.button_submit.place(x=280, y=490, width=70, height=30)
        self.button_reset.place(x=420, y=490, width=70, height=30)

        self.frame.place(x=50, y=266, width=630, height=200)
        ...
        self.label_up_to.place(x=40, y=100, width=70, height=30)
        self.check_hudbt.place(x=120, y=100, width=70, height=30)
        self.check_nypt.place(x=210, y=100, width=70, height=30)
        self.check_tjupt.place(x=300, y=100, width=70, height=30)
        self.check_mteam.place(x=390, y=100, width=70, height=30)

        self.check_ssd.place(x=480, y=100, width=70, height=30)
        self.check_ourbits.place(x=120, y=140, width=70, height=30)
        self.check_hdsky.place(x=210, y=140, width=70, height=30)
        self.check_hdchina.place(x=300, y=140, width=70, height=30)
        self.check_ttg.place(x=390, y=140, width=70, height=30)
        self.check_pter.place(x=480, y=140, width=70, height=30)
        ...
        self.bool_check_hudbt.set(self.config_dl['up_to_hudbt'])
        self.bool_check_nypt.set(self.config_dl['up_to_nypt'])
        self.bool_check_tjupt.set(self.config_dl['up_to_tjupt'])
        self.bool_check_mteam.set(self.config_dl['up_to_mteam'])

        self.bool_check_ssd.set(self.config_dl['up_to_cmct'])
        self.bool_check_ourbits.set(self.config_dl['up_to_ourbits'])
        self.bool_check_hdsky.set(self.config_dl['up_to_hdsky'])
        self.bool_check_hdchina.set(self.config_dl['up_to_hdchina'])
        self.bool_check_ttg.set(self.config_dl['up_to_ttg'])
        self.bool_check_pter.set(self.config_dl['up_to_pter'])
    ...
    def submit_configur_dl(self):
        ...
        self.config_dl['up_to_hudbt'] = self.bool_check_hudbt.get()
        self.config_dl['up_to_nypt'] = self.bool_check_nypt.get()
        self.config_dl['up_to_tjupt'] = self.bool_check_tjupt.get()
        self.config_dl['up_to_mteam'] = self.bool_check_mteam.get()

        self.config_dl['up_to_cmct'] = self.bool_check_ssd.get()
        self.config_dl['up_to_ourbits'] = self.bool_check_ourbits.get()
        self.config_dl['up_to_hdsky'] = self.bool_check_hdsky.get()
        self.config_dl['up_to_hdchina'] = self.bool_check_hdchina.get()
        self.config_dl['up_to_ttg'] = self.bool_check_ttg.get()
        self.config_dl['up_to_pter'] = self.bool_check_pter.get()
        ...
        self.controller.config_dl = common_methods.load_config_dl()
        self.controller.frames['AutoUploadPage'].config_dl = common_methods.load_config_dl()
        self.controller.frames['HandUploadPage'].config_dl = common_methods.load_config_dl()
