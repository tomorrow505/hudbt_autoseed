...
mteam = {
    'abbr': 'mteam',
    'domain': 'pt.m-team.cc',
    'index': 'https://pt.m-team.cc/index.php',
    'passkey': '',
    'cookie': []
}
ourbits = {
...
pter = {
    'abbr': 'Pter',
    'domain': 'pterclub.com',
    'index': 'https://pterclub.com/index.php',
    'passkey': '',
    'cookie': []
}
pthome = {
    'abbr': 'pthome',
    'domain': 'pthome.net',
    'index': 'https://pthome.net/index.php',
    'passkey': '',
    'cookie': []
}
beitai = {
    ...
    'index': 'http://www.beitai.pt/index.php',
    'passkey': '',
    'cookie': []
}
chd = {
    'abbr': 'chd',
    'domain': 'chdbits.co',
    'index': 'https://chdbits.co/index.php',
    'passkey': '',
    'cookie': []
}
u2 = {
    'abbr': 'U2',
    'domain': 'u2.dmhy.org',
    'index': 'https://u2.dmhy.org/index.php',
    'passkey': '',
    'cookie': []
}
hdstreet = {
    'abbr': 'hdstreet',
    'domain': 'hdstreet.club',
    'index': 'https://hdstreet.club/index.php',
    'passkey': '',
    'cookie': []
}
...
ptp = {
    ...
    'index': 'https://passthepopcorn.me/index.php',
    'passkey': '',
    'cookie': []
}

sites_dict = {
    "蝴蝶": hudbt, "北邮人": byr, "蒲公英": npupt, "葡萄": stju, "北洋园": tjupt, "南洋": nypt, "M-team": mteam, "OurBits": ourbits,
    "CMCT": cmct, "瓷器": hdchina, "TTG": ttg, "天空": hdsky, "朋友": frds, 'hdhome': hdhome, '麦田': nwsuaf6, '猫站': pter,
    'PThome': pthome, 'CHD': chd, 'beitai': beitai, 'U2': u2, 'hdstreet': hdstreet
}
back_site_dict = {
    "北邮人": byr, "蒲公英": npupt, "葡萄": stju, "北洋园": tjupt, "南洋": nypt, "M-team": mteam, "OurBits": ourbits, "CMCT": cmct,
    "瓷器": hdchina, "TTG": ttg, "天空": hdsky, "蝴蝶": hudbt, "朋友": frds, 'hdhome': hdhome, '麦田': nwsuaf6, '猫站': pter,
    'PThome': pthome, 'CHD': chd, 'beitai': beitai, 'U2': u2, 'hdstreet': hdstreet
}

config_dl = common_methods.load_config_dl()
if 'full_version' in config_dl.keys():
    sites_dict['ptp'] = ptp
    back_site_dict['ptp'] = ptp
...
class ConfigSitesPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.entry_user_data = Entry(self, textvariable=self.var_user_data, width=58, borderwidth=2,
                                     font=("Helvetica", 10))
        ...
        self.entry_1 = Entry(self, textvariable=self.var, width=58, borderwidth=2, font=("Helvetica", 10))
        ...
        self.btnGetCookie = tk.Button(self, text='获取COOKIE', command=self.thread_get_cookie)

        self.create_page()

    def create_page(self):
        self.button_2.place(x=610, y=15, width=80, height=28)
        self.entry_user_data.place(x=32, y=15, width=560, height=28)
        ...
        self.button.place(x=610, y=80, width=80, height=28)
        self.entry_1.place(x=32, y=80, width=560, height=28)
        ...
        self.add_site.place(x=32, y=130, width=700, height=400)

        # 获取cookie按钮
        # self.btnLoadCookie.place(x=60, y=550, width=120, height=30)
        # 删除按钮
        self.btnDelete.place(x=150, y=550, width=120, height=30)
        # 获取cookie按钮
        self.btnGetCookie.place(x=500, y=550, width=120, height=30)
    ...
    def thread_get_cookie(self):
        t = threading.Thread(target=self.get_cookie, args=())
        t.start()

    # 获取cookies
    def get_cookie(self):
        if os.path.exists(USER_DATA_PATH):
            site_chosen = common_methods.load_pt_sites()
            try:
    ...
    def save_user_data(self):
        user_data = {'user_data': self.var_user_data.get(), 'reseed_info': ''}
